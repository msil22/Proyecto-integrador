const usersData = [
    ...
    {id:8, nombre: 'Roberto Ruiz', edad: 19, profesion: 'No Informada', disponibilidad: 'Disponible'},
    {id:9, nombre: 'Carlos Perez', edad: 29, profesion: 'Obrero(a)', disponibilidad: 'Búsqueda Activa'},
    {id:10, nombre: 'Joaquín Rojas', edad: 30, profesion: 'Enfermero(a)', disponibilidad: 'No disponible'},
    {id:11, nombre: 'Pedro Gonzalez', edad: 29, profesion: 'Informático(a)', disponibilidad: 'Búsqueda Activa'},
    {id:12, nombre: 'Natalia López', edad: 48, profesion: 'Vendedor(a)', disponibilidad: 'Búsqueda Activa'},
]
