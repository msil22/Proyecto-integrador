...
function FormularioEmpresa() {
  return (
    ...
    <div id="formulario-container">
        ...
        <div className="mb-3">
            <label htmlFor="formGroupExampleInput2" className="form-label">Rut</label>
            <input type="text" className="form-control" id="formGroupExampleInput2" placeholder="11.111.111-1"/>
        </div>
        <div className="mb-3">
            <label htmlFor="exampleDataList" className="form-label">Giro o rubro</label>
        ...
        <div className="mb-3">
            <label htmlFor="formGroupExampleInput" className="form-label">Cantidad de empleados</label>
            <input type="text" className="form-control" id="formGroupExampleInput5" placeholder="Ejemplo: 60"/>
        </div>   
        <div className="mb-3">
            <label htmlFor="formGroupExampleInput" className="form-label">Acerca de</label>
        ...
        <div className="mb-3">
            <label htmlFor="formGroupExampleInput2" className="form-label">Celular</label>
            <input type="text" className="form-control" id="formGroupExampleInput6" placeholder="+569 1234 5678"/>
        </div>
        <div className="mb-3">
            <label htmlFor="formGroupExampleInput" className="form-label">Correo</label>
            <input type="text" className="form-control" id="formGroupExampleInput7" placeholder="Ejemplo@gmail.com"/>
        </div>
        <div className="mb-3">
            <label htmlFor="formGroupExampleInput" className="form-label">URL de página web</label>
